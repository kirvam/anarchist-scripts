...
while (<DATA>) {
  ...
  print "$_\n";
  # name must be unique
  #@cat{'parent','type','note'} = split /:/;
  @cat{'id','note','parent'} = split /,/;
...
#id,name,parent
__DATA__
aircraft,flying machine,top
P38,P38 Lightning,aircraft
P51,P51 Mustang,aircraft
P38-Note1,Twin boom.,P38
P38-Note2,Most kills.,P38
P51-Note1,Fighter Escort.,P51
P51-Note2,Very Fast.,P51
P51-Metric1,430 mph.,P51
